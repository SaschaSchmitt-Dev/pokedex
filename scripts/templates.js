...
function getPokemonDialogTemplate(data) {
    ...
    <div class="interaction_buttons_container">
        <button data-id="prev-button" aria-label="Zurück" class="dialog_interaction_button turn_button" onclick="openPreviousPokemon()">➪</button>
        <button data-id="close-dialog-button" aria-label="Schließen" class="dialog_interaction_button" onclick="closeDialog('pokemonDetailsDialog')">🗙</button>
        <button data-id="next-button" aria-label="Weiter" class="dialog_interaction_button" onclick="openNextPokemon()">➪</button>
    </div>
